...
public class Processo {
    ...
    @JoinColumn(name = "CDASSUNTO", nullable = false) @ManyToOne private Assunto assunto;
    @JoinColumn(name = "CDINTERESSADO", nullable = false) @ManyToOne private Interessado interessado;
}
